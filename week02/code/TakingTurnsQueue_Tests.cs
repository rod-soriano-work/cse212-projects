...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue() was inserting at index 0 (front) instead of appending to back. TakingTurnsQueue.GetNextPerson() did not handle infinite turns (turns <= 0) correctly.
