...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            // if the current node contains 'value', then remove it
            if (curr.Data == value)
            {
                if (curr == _head) // if it's the head node
                {
                    RemoveHead();
                }
                else if (curr == _tail) // if it's the tail node
                {
                    RemoveTail();
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            // if the current node contains 'oldValue', then replace it
